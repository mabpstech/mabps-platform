...
export const INDUSTRY_LEXICON: Array<{
  ...
  },
  {
    ...
    category: "professional",
    keywords: ["pet clinic", "veterinary", "vet clinic", "vaccinations"],
    features: ["vaccinations", "surgery", "dental care", "wellness checkups"],
  ...
  },
  {
    label: "accounting",
    category: "professional",
    keywords: ["accountant", "accounting", "chartered accountant", "ca firm", "bookkeeping", "gst"],
  ...
  },
  {
    label: "travel agency",
    category: "services",
    keywords: ["travel agency", "tour", "honeymoon", "holiday package", "backwater"],
  ...
  },
  {
    label: "saas",
    category: "other",
    keywords: ["saas", "software", "b2b", "platform", "onboarding", "workflows"],
  ...
  },
  {
    label: "nonprofit",
    category: "other",
    keywords: ["nonprofit", "ngo", "charity", "foundation", "scholarships"],
